...
_C.INFERENCE.FORCE_STOP_MAX_STEPS_ENABLED = True
_C.INFERENCE.FORCE_STOP_MAX_STEPS = 100
...
_C.MEMORY.STRATEGY = "uniform"  # options: uniform, candidate_a, candidate_b_v1, candidate_b_v2, candidate_b_v3
...
_C.MEMORY.SUBGOAL_PARSER = CN()
_C.MEMORY.SUBGOAL_PARSER.USE_LLM = False
_C.MEMORY.SUBGOAL_PARSER.BACKEND = "openai_compatible"
_C.MEMORY.SUBGOAL_PARSER.MODEL = "qwen-flash"
_C.MEMORY.SUBGOAL_PARSER.API_BASE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
_C.MEMORY.SUBGOAL_PARSER.API_KEY_ENV = "DASHSCOPE_API_KEY"
_C.MEMORY.SUBGOAL_PARSER.TIMEOUT_SECONDS = 8
_C.MEMORY.SUBGOAL_PARSER.MAX_SUBGOALS = 8
_C.MEMORY.SUBGOAL_PARSER.FALLBACK_TO_RULE = True
_C.MEMORY.SUBGOAL_PARSER.REQUIRE_LLM_SUCCESS = False
_C.MEMORY.USE_SUBGOAL_FOR_RELEVANCE = False
_C.MEMORY.USE_TRAJECTORY_TRACE = False
_C.MEMORY.ENABLE_TRACE_IN_PROMPT = False
_C.MEMORY.ENABLE_STAGE_AWARE_ROUTING = False
_C.MEMORY.USE_TEXT_SEMANTIC_RELEVANCE = False
_C.MEMORY.TEXT_EMBED_DIM = 128
_C.MEMORY.TURN_THRESHOLD_DEGREES = 15.0
_C.MEMORY.MIN_FRAME_GAP = 4
_C.MEMORY.ENABLE_COV_IN_SCORE = False
_C.MEMORY.ENABLE_TURN_IN_SCORE = False

_C.MEMORY.DECO_REFINE = CN()
_C.MEMORY.DECO_REFINE.ENABLE = True
_C.MEMORY.DECO_REFINE.INITIAL_WINDOW_SIZE = 8
_C.MEMORY.DECO_REFINE.REFINED_HISTORY_SIZE = 7
_C.MEMORY.DECO_REFINE.CANDIDATE_POOL_MAX = 120
_C.MEMORY.DECO_REFINE.LAMBDA_R = 0.65
_C.MEMORY.DECO_REFINE.W_VIS = 0.6
_C.MEMORY.DECO_REFINE.W_TEMP = 0.4
_C.MEMORY.DECO_REFINE.EPSILON = 1e-6

_C.MEMORY.STAGE_TRACKER = CN()
_C.MEMORY.STAGE_TRACKER.ENABLE = True
_C.MEMORY.STAGE_TRACKER.INTERVAL = 10
_C.MEMORY.STAGE_TRACKER.MAX_STAGE_DELTA = 1
_C.MEMORY.STAGE_TRACKER.CONFIDENCE_THRESHOLD = 0.0
_C.MEMORY.STAGE_TRACKER.MAX_EVIDENCE_CHARS = 180

_C.MEMORY.LOOP_RECOVERY = CN()
_C.MEMORY.LOOP_RECOVERY.ENABLE = True
_C.MEMORY.LOOP_RECOVERY.MIN_CONSECUTIVE_LOOP_SIGNALS = 2
_C.MEMORY.LOOP_RECOVERY.HINT_STEPS = 3
_C.MEMORY.LOOP_RECOVERY.ACTION_DOMINANCE_THRESHOLD = 0.75
_C.MEMORY.LOOP_RECOVERY.MAX_REPEAT_SAME_ACTION = 1
_C.MEMORY.LOOP_RECOVERY.FORCE_FORWARD_AFTER_CONSECUTIVE_TURNS = 6
_C.MEMORY.LOOP_RECOVERY.EVIDENCE_KEYWORDS = ["loop", "same action", "repeated", "stuck"]

_C.MEMORY.WEIGHTS = CN()
_C.MEMORY.WEIGHTS.RELEVANCE = 0.75
_C.MEMORY.WEIGHTS.NOVELTY = 0.25
_C.MEMORY.WEIGHTS.TURN_BONUS = 0.0
_C.MEMORY.WEIGHTS.COVERAGE = 0.0
...
_C.INFERENCE.STOP_GUARD = CN()
_C.INFERENCE.STOP_GUARD.ENABLED = False
_C.INFERENCE.STOP_GUARD.MODE = "fusion"  # options: none, consecutive, distance, trace, fusion
_C.INFERENCE.STOP_GUARD.CONSECUTIVE_THRESHOLD = 2
_C.INFERENCE.STOP_GUARD.DISTANCE_THRESHOLD_M = 1.0
_C.INFERENCE.STOP_GUARD.REQUIRE_FINAL_STAGE = True
_C.INFERENCE.STOP_GUARD.FUSION_REQUIRE_CONSECUTIVE = True
_C.INFERENCE.STOP_GUARD.FUSION_REQUIRE_DISTANCE = True
_C.INFERENCE.STOP_GUARD.FUSION_REQUIRE_FINAL_STAGE = True
